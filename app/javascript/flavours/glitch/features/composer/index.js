...
import ComposerLongWarning from './st_long_warning';
  ...
  render () {
    ...
    return (
      <div className='composer'>
        ...
        {text.length > 1000 ? <ComposerLongWarning /> : null}
        {inReplyTo && (
          <ComposerReply
            status={inReplyTo}
            intl={intl}
        ...
        />
        <ComposerPublisher
          countText={spoilerText ? '∞' : `${spoilerText}${countableText(text)}${advancedOptions && advancedOptions.get('do_not_federate') ? ' 👁️' : ''}`}
